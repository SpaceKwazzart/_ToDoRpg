"""
Django settings for reachTheTop project.
...
SECRET_KEY = 'django-insecure-vn_zjh@-bf5b7t+69_stuen$y7g%(zm$ug=^cxi1c2pt00s()5'
...
WSGI_APPLICATION = 'reachTheTop.wsgi.application'
